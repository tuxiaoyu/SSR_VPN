...
const char jcc_h_rcs[] = SHIP_H_VERSION;
...
static void listen_loop(ShipTunnel_cb cb, void *data);
 ...
 *
 *********************************************************************/
int island_main(char *conf_path, struct forward_spec *forward_proxy_list, ShipTunnel_cb cb, void *data)
{
