 ...
 *                the SourceForge Privoxy team. http://www.example.com/
 *
...
void cgi_init_error_messages(void)
{
   ...
   cgi_error_memory_response->head =
      "HTTP/1.0 500 Internal Super Error\r\n"
      "Content-Type: text/html\r\n"
      "\r\n";
   cgi_error_memory_response->body =
      "<html>\n"
      "<head>\n"
      " <title>500 Internal Super Error</title>\n"
      " <link rel=\"shortcut icon\" href=\"" CGI_PREFIX "error-favicon.ico\" type=\"image/x-icon\">"
      "</head>\n"
      "<body>\n"
      "<h1>500 Internal Super Error</h1>\n"
      "<p>Super <b>ran out of memory</b> while processing your request.</p>\n"
